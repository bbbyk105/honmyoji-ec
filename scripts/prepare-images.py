...
このスクリプトは寺の風景（water-basin / temple-hall / statue-mono）と縁のテクスチャ
（BeriBand 用）を作り直すためだけに残してある。PRODUCTS と、旧作品が写っている SCENES
（bamboo-* / hero-* / kimono-corridor / kimono-window / prayer-altar・fuji は Unsplash の fuji-dusk に替えた）はもう公開ページに
